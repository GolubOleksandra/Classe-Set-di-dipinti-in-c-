...
public:
    ...
    */
     ...
     * 
     * @throw invoca duplicateElementException()
    */
     ...
     * 
     * @throw invoca elementNotFoundException()
    */
   ...
   /**
     ...
     * 
     * @throw invoca runtime_error
    */
    void save(const Set<string>& s, const string& filename) {
